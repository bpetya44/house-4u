...
var TripsClient = function (_a) {
    ...
    return (React.createElement(Container_1["default"], null,
        React.createElement(Heading_1["default"], { title: "Trips", subtitle: "Your reservations" }),
        React.createElement("div", { className: "\r\n        mt-10 \r\n        grid \r\n        grid-cols-1\r\n        sm:grid-cols-2\r\n        md:grid-cols-3\r\n        lg:grid-cols-4\r\n        xl:grid-cols-5\r\n        \r\n        gap-8\r\n        " }, reservations.map(function (reservation) { return (React.createElement(ListingCard_1["default"], { key: reservation.id, data: reservation.listing, reservation: reservation, actionId: reservation.id, onAction: onCancel, disabled: deletingId === reservation.id, actionLabel: "Cancel reservation", currentUser: currentUser })); }))));
};
