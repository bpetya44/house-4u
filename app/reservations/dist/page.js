...
var ReservationsClient_1 = require("./ReservationsClient");
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (reservations.length === 0) {
                    return [2 /*return*/, (React.createElement(EmptyState_1["default"], { title: "No reservations", subtitle: "It looks like you haven no reservations yet on your properties." }))];
                }
                return [2 /*return*/, (React.createElement(ReservationsClient_1["default"], { reservations: reservations, currentUser: currentUser }))];
        }
    });
}); };
